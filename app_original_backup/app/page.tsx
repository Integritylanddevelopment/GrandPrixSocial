...
import { Trophy, Users, Newspaper, ShoppingBag, Gamepad2, Flag, Zap, Calendar, Clock } from "lucide-react"
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
          ...
          <Link href="/cafe">
            <Card className="group hover:scale-105 transition-all duration-300 bg-gradient-to-br from-orange-600/10 to-red-600/10 border-orange-500/30 hover:border-orange-400">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Café</h3>
          ...
          <Link href="/race-schedule">
            <Card className="group hover:scale-105 transition-all duration-300 bg-gradient-to-br from-red-600/10 to-orange-600/10 border-red-500/30 hover:border-red-400">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Race Schedule</h3>
                <p className="text-gray-400 text-sm mb-4">2025 F1 calendar & streaming</p>
                <div className="flex justify-center gap-2">
          ...
          <Card className="bg-gradient-to-r from-red-600/10 to-orange-600/10 border-red-500/30">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Bahrain Grand Prix</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-red-400">March 16</div>
                  <div className="text-sm text-gray-400">15:00 AST</div>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <Link href="/race-schedule">
                  <Badge className="bg-red-600 hover:bg-red-700 text-white">View Full Schedule</Badge>
                </Link>
              </div>
            </CardContent>
          </Card>
