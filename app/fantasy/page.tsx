              ...
              {leagues.map((league) => (
                <Card key={league.id} className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-colors">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button className="w-full bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 hover:text-blue-300 transition-all duration-200">
                      Join League
                    </Button>
                  </CardContent>
                </Card>
