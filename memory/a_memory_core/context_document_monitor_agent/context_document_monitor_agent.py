...
class ContextDocumentMonitor:
    def __init__(self, config_path: str = None):
        ...
        # Memory system paths
        self.short_term_path = Path("C:/D_Drive/ActiveProjects/GrandPrixSocial/memory/c_short_term_memory")
        self.working_memory_path = Path("C:/D_Drive/ActiveProjects/GrandPrixSocial/memory/d_working_memory")
        self.long_term_path = Path("C:/D_Drive/ActiveProjects/GrandPrixSocial/memory/b_long_term_memory")
