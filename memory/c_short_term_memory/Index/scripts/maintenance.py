...
#!/usr/bin/env python3
"""
Index Maintenance Agent - Cleanup and optimization for index system
Handles cleanup, optimization, and maintenance tasks for the indexing system
"""
...
class IndexMaintenance:
    ...
    def run_maintenance(self):
        ...
        self.logger.info("Starting index maintenance")
        ...
        self.logger.info(f"Index maintenance complete: {tasks_completed} tasks completed")
    ...
    def optimize_indexes(self):
        ...
        try:
            ...
            original_count = len(index.get('indexed_files', {}))
            valid_files = {}
            
            for file_key, file_info in index.get('indexed_files', {}).items():
                if os.path.exists(file_info.get('path', '')):
                    valid_files[file_key] = file_info
            
            index['indexed_files'] = valid_files
